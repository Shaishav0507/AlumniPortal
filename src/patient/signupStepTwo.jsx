...
import { signUpStepTwo } from './apiActions';
...
this.setState({
  ...
  fileVal:ev.target.files[0]
})
  }

  patientSignupStepTwo =async (ev) => {
    ev.preventDefault();
    this.formValidation().then((value) => {
      if (value) {
        ...
        let formDataOwn = new FormData();
        formDataOwn.append('userToken', localStorage.getItem('userToken'))
        formDataOwn.append('userId', localStorage.getItem('userId'))
        formDataOwn.append('firstName', this.state.firstName)
        formDataOwn.append('lastName', this.state.lastName)
        formDataOwn.append('birthDate', this.state.dob)
        formDataOwn.append('contactNumber', this.state.phone)
        formDataOwn.append('role', 1)
        formDataOwn.append('fileUpload',this.state.fileVal, this.state.fileName)
        this.setState({
          firstName: '',
          lastName: '',
          dob: '',
                ...
                <div className="col-12 px-0">
                  ...
                  <div className="container-fluid h-100">
                    <div className="row h-100">
                      ...
                      <div className="col-md-7 col-12 bg-wrapper" style={{ backgroundImage: 'url(/assets/img/img-3.png)' }}>
                      </div>
                      <div className="col-md-5 col-12 bg-white right-side-form">
                        <div className="px-0 px-md-2">
                          ...
                          <form encType="multipart/form-data" className="form-own" onSubmit={(ev) => this.patientSignupStepTwo(ev)}>
                            ...
                            <input type="file" onChange={(ev) => this.changeValueFile(ev)} value={this.state.file} name="fileName" placeholder="Last Name" className="form-control" />
...
export default withRouter(SignUpStepTwo); 