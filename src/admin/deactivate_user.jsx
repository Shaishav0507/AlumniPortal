              ...
              <div className="row">
                <div className="col-12 text-center">
                  ...
                  <div className="own-txt own-close-txt color-blue-three">
                    You can deactivate user, for particular user to your Alumni
                    Portal using the activate button below.
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="upload-wrapper">
                              <button
                                className="btn upload-btn btn-main"
                                disabled
                              >
                                Deactivate
                              </button>
...
export default withRouter(DeactivateUser);
